...
// 		"apiUrl"=>"http://192.168.2.244",
		...
		"numbers"=>array(
			...
			"showDetails"=>"/v2/PurchasedPhoneNumbers/",//  /v2/PurchasedPhoneNumbers/{number}
			"doReleased"=>"/v2/PurchasedPhoneNumbers/", //  /v2/PurchasedPhoneNumbers/{number}
				//Availabel Number
			...
			"doRemoved"=>"/v2/AvailablePhoneNumbers/",//    /v2/AvailablePhoneNumbers/{number}
		),
		//Trunks
		"trunks"=>array(
			"showList"=>"/v2/Trunks",
			...
			"addAuth"=>"/v2/Trunks/{0}/Credentials/{1}" , ///v2/Trunks/{sipTrunkId}/Credentials/{sipTrunkAuthId}
			"removeAuth"=>"/v2/Trunks/{0}/Credentials/{1}", ///v2/Trunks/{sipTrunkId}/Credentials/{sipTrunkAuthId}
			"createAuth"=>"/v2/Credentials",
			"editAuth"=>"/v2/Credentials/", ///v2/Credentials/{id}
			'selectAuthList'=>"/v2/Credentials/", ///v2/Credentials/{sipTrunkId}
			...
			"editIp"=>"/v2/IpAccessControlLists/", ///v2/IpAccessControlLists/{id}
