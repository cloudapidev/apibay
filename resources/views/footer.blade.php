    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2014-2015 <a href="http://globalroam.com">Globalroam Pte Ltd</a>.</strong> All rights reserved.
      </footer>
    ...
    <script src="{{ asset ("/bower_components/admin-lte/plugins/select2/select2.full.min.js") }}"></script>
        ...
        $('.sidebar-menu').find('a').each(function(){
            ...
            <?php $arr = explode(",",$active);
              foreach($arr as $key=>$val){
            ?>

              if($(this).parent().hasClass('<?=trim($val)?>'))
