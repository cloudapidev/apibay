                  ...
                  <li><a href="#tab_4" data-toggle="tab"><i class="fa fa-phone-square"></i> Assigned Numbers</a></li>
										...
										<div class="box-body" >
											...
											<div class="tab-pane" id="tab_2">
												<div class="form-group">
														<label class="control-label col-sm-3" for="user_full_name">Termination URI</label>
														<div class="col-sm-4">
															...
															<table class="table table-bordered table-striped table-condensed cf">
																...
																<tbody>
																	<tr>
																		...
																		<td>GR PBX</td>
																		<td>192.12.2.4</td>
																		<td><a href="#"  id="user_submit" name="commit" type="submit" value="Add user" data-toggle="modal" data-target="#myModalip">Edit</a></td>
																	</tr>
																	<tr>
																		<td>2</td>
																		<td>GNUM Call Center</td>
																		<td>65.12.2.42</td>
																		<td>	<a href="#"  id="user_submit" name="commit" type="submit" value="Add user" data-toggle="modal" data-target="#myModalip">Edit</a></td>
																	</tr>
																</tbody>
											...
											<div class="tab-pane" id="tab_3">
												...
												<div class="form-group">
													...
													<div class="form-group">
														...
														<label class="control-label col-sm-2" style="text-align:left;" for="user_full_name"><?=(isset($data['channel'])&& $data['channel']!=""?$data['channel']:"1")?></label>
													</div>
											</div>
											<!-- End origination -->
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<div class="col-sm-8">
														<a href="siptrunk-listing.php?success" class="btn btn-default" name="commit" onclick="gHistoryBack()" type="submit" value="">Cancel </a>
														<a href="siptrunk-listing.php?success" class="btn btn-success" id="user_submit" name="commit" type="submit" value="Add user">Save</a>
													</div>
												</div>
											</div>
										</div>
									...
									<form class="form-horizontal">
											...
											<div class="box-body">
												...
												<div class="form-group">
													...
													<div class="col-xs-4">
														<input type="text" class="form-control" placeholder="Enter ..." value="GR PBX">
													</div>
												...
												<div class="form-group margin">
													...
													<div class="col-xs-4">
														<input type="text" class="form-control" placeholder="Enter ..." value="145.24.21.111">
													</div>
